...
(def input [[1224	926	1380	688	845	109	118	88	1275	1306	91	796	102	1361	27	995]
...
(defn calculate-spreadsheet-checksum-1
  [sheet]
  (let [hilo (juxt (partial apply max) (partial apply min))]
    (->> sheet
         (map hilo)
         (map (partial apply -))
         (reduce +))))
...
(deftest example-1
  (is (= 18 (calculate-spreadsheet-checksum-1 [[5 1 9 5]
                                               [7 5 3]
                                               [2 4 6 8]]))))
